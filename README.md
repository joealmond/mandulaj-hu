...
| ------------------------- | --------------------------------------------------------------------- |
| **README.md** (this file) | How to publish, unpublish, run it, add a feature                      |
| [ADR.md](ADR.md)          | The stack, why each decision was made, what is where, stock vs custom |
| [TODO.md](TODO.md)        | Everything still open, with checkboxes                                |
| [CLAUDE.md](CLAUDE.md)    | Gotchas that will bite during maintenance                             |
...
See [TODO.md](TODO.md) §4. The short version: add the domain to Cloudflare,
...
After any upgrade, re-read the "Gotchas" in [CLAUDE.md](CLAUDE.md) — several
...
> Two traps when writing components, both explained in [CLAUDE.md](CLAUDE.md):
